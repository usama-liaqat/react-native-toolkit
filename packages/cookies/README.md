...
- [Usama Liaqat](https://github.com/usama-liaqat)

## Features
- ✅ Supports iOS and Android
- ✅ Get, set, clear, and list cookies easily
- ✅ Supports WebKit cookies on iOS (WKWebView)
- ✅ TypeScript ready
- 🚫 No Expo Go support (native code required)
...
| ----------- | -------------- | ------------------------------------------------------------------------ |
| getAll      | ✅            | `CookieManager.getAll(useWebKit:boolean)`                                |
| clearAll    | ✅            | `CookieManager.clearAll(useWebKit:boolean)`                              |
| clearByName | ✅            | `CookieManager.clearByName(url:string, name: string, useWebKit:boolean)` |
| get         | ✅            | `CookieManager.get(url:string, useWebKit:boolean)`                       |
| set         | ✅            | `CookieManager.set(url:string, cookie:object, useWebKit:boolean)`        |
